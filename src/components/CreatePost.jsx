    ...
    const handleCreatePost = async (e) => {
        ...
        try {
            ...
            await addDoc(collection(db, 'posts'), {
                ...
                imageURL: imageURL,
                tags: tags, // Guardamos el array de etiquetas
                authorId: user.uid,
                ...
                <div className="mt-4">
                    <div className="flex items-center gap-2">
                        ...
                        <input 
                            ...
                            className="input !w-auto flex-grow !py-1 text-sm dark:bg-gray-700"
                            placeholder="Añade hasta 5 etiquetas (pulsa espacio para añadir)"
